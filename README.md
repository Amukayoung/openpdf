...
This package allows you to generate PDF files from React components using Puppeteer. Follow the steps below to use this NPM package
...
This package utilizes the power of [Puppeteer](https://github.com/puppeteer/puppeteer) for browser automation and [ReactDOMServer](https://reactjs.org/docs/react-dom-server.html) for rendering React components to HTML. Thanks to the owners
